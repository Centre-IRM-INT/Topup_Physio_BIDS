...
cp /Volumes/Stimulation/"MANIP_${study}"/sourcedata/$sub/sub*.tsv $FUNCDIR/
cp /Volumes/Stimulation/"MANIP_${study}"/sourcedata/$sub/*.txt $OUTDIR/
cp /Volumes/Stimulation/"MANIP_${study}"/sourcedata/$sub/sub*.tsv $OUTDIR/
cp /Volumes/Stimulation/"MANIP_${study}"/sourcedata/$sub/sub*.edf $OUTDIR/
cp -f /Volumes/Stimulation/"MANIP_${study}"/sourcedata/$sub/*.wav $OUTDIR/
